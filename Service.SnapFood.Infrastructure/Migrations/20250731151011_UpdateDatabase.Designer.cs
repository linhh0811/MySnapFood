...
namespace Service.SnapFood.Infrastructure.Migrations
{
    ...
    [Migration("20250731151011_UpdateDatabase")]
            ...
            modelBuilder.Entity("Service.SnapFood.Domain.Entitys.ProductCombo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("908fb4f3-34b9-427e-a71e-839560246342"),
                        ...
                        new
                        {
                            Id = new Guid("6fd666fc-81d0-4cf2-a3c9-017e2d2c898f"),
                            ComboId = new Guid("a1b2c3d4-e5f6-4789-abcd-1234567890ad"),
                            Created = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = new Guid("42850115-44d1-41c4-a40e-16056095c109"),
                            ComboId = new Guid("a1b2c3d4-e5f6-4789-abcd-1234567890ad"),
                            Created = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = new Guid("dfc72c86-61e4-4fac-a9d3-23a2ca06a004"),
                        ...
                        new
                        {
                            Id = new Guid("d9dfe69c-b627-4831-8d8a-ea47b27b0646"),
                            ComboId = new Guid("a1b2c3d4-e5f6-4789-abcd-1234567890ac"),
                            Created = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ProductId = new Guid("85c5e5a3-9a3d-4d9a-a09c-74647eb07bfc"),
                            Quantity = 1
                        ...
                        new
                        {
                            Id = new Guid("d61e49aa-db7a-420f-8fe3-455a43bea6a2"),
                        ...
                        new
                        {
                            Id = new Guid("762b167e-42b6-4813-8353-09cd7a11f4c4"),
                            ComboId = new Guid("a1b2c3d4-e5f6-4789-abcd-1234567890ab"),
                            Created = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = new Guid("728bff96-c210-420e-a106-863ba82dbdc3"),
                            ComboId = new Guid("a1b2c3d4-e5f6-4789-abcd-1234567890ab"),
                            Created = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ProductId = new Guid("85c5e5a3-9a3d-4d9a-a09c-74647eb07bfc"),
                            Quantity = 1
                        ...
                        new
                        {
                            Id = new Guid("051b4b1d-2b58-4383-9abc-376358dba99d"),
                        ...
                        new
                        {
                            Id = new Guid("a12d3405-102c-42f2-93d4-ee4b676cf761"),
                            ComboId = new Guid("b2c3d4e5-f6a7-4890-abcd-2345678901bc"),
                            Created = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ProductId = new Guid("e1bb1ea5-94b2-45c7-98a2-b1fa0f4e3e6d"),
                            Quantity = 1
                        ...
                        new
                        {
                            Id = new Guid("c13f8b78-0f9d-45e2-83d8-d104d999070a"),
                            ComboId = new Guid("b2c3d4e5-f6a7-4890-abcd-2345678901bc"),
                            Created = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ProductId = new Guid("85c5e5a3-9a3d-4d9a-a09c-74647eb07bfc"),
                            Quantity = 1
                        ...
                        new
                        {
                            Id = new Guid("7c74dab8-c8fe-4212-901e-660be652a9de"),
                        ...
                        new
                        {
                            Id = new Guid("e10b06a9-f22b-4c9d-ad26-758cea3693e8"),
                            ComboId = new Guid("c3d4e5f6-a7b8-4901-bcde-3456789012cd"),
                            Created = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ProductId = new Guid("e1bb1ea5-94b2-45c7-98a2-b1fa0f4e3e6d"),
                            Quantity = 1
                        ...
                        new
                        {
                            Id = new Guid("23724504-3448-4b0e-b41b-9da274077694"),
                            ComboId = new Guid("c3d4e5f6-a7b8-4901-bcde-3456789012cd"),
                            Created = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ProductId = new Guid("85c5e5a3-9a3d-4d9a-a09c-74647eb07bfc"),
                            Quantity = 1
            ...
            modelBuilder.Entity("Service.SnapFood.Domain.Entitys.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastModifiedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            ModerationStatus = 0,
                            Password = "$2a$11$b.UjZVyqmGQDXzOb9uy/nOISNkeIwzDWtVnilghZj/R3mASLWxCV2",
                        ...
                        new
                        {
                            ...
                            LastModifiedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            ModerationStatus = 0,
                            Password = "$2a$11$ExmUTMkEqABDy8f.tk0blexvsRifxCV6mBKXmqHwW.HKashM3XSAy",
                            StoreId = new Guid("8a2e5d21-5f6b-4a7c-9d5e-3f6c8b2a1d0e"),
                            UserType = 1
                        });
                });
            ...
            modelBuilder.Entity("Service.SnapFood.Domain.Entitys.DiscountCodeUsage", b =>
                {
                    ...
                    b.HasOne("Service.SnapFood.Domain.Entitys.User", "User")
                        .WithOne("DiscountCodeUsage")
                        .HasForeignKey("Service.SnapFood.Domain.Entitys.DiscountCodeUsage", "UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
